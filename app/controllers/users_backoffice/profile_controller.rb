class UsersBackoffice::ProfileController < UsersBackofficeController
  ...
  def params_user
    params.require(:user).permit(:first_name, :last_name, :email,:password, :password_confirmation, user_profile_attributes: [:id,
    :zip_code, :address, :gender, :birthdate, :avatar])
  end
